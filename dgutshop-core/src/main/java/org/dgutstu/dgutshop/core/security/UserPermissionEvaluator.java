...
public class UserPermissionEvaluator implements PermissionEvaluator {
     ...
     * 当然targetUrl不一定是URL，可以是数据Id还可以是管理员标识等,这里根据需求自行设计
    ...
    public boolean hasPermission(Authentication authentication, Object targetUrl, Object permission) {
        ...
        List<DgutshopPermission> permissionList = adminService.selectPermissionByUserId(loginUser.getUserId());
        for (DgutshopPermission dgutshopPermission : permissionList) {
            permissions.add(dgutshopPermission.getPermission());
        }
        // 权限对比
