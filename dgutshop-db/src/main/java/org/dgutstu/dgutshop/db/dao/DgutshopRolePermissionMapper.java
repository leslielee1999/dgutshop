...
public interface DgutshopRolePermissionMapper {
     ...
     * @mbg.generated
     */
    DgutshopRolePermission selectByPrimaryKeySelective(@Param("id") Long id, @Param("selective") DgutshopRolePermission.Column ... selective);
     ...
     * @mbg.generated
     */
    DgutshopRolePermission selectByPrimaryKey(Long id);
     ...
     * @mbg.generated
     */
    DgutshopRolePermission selectByPrimaryKeyWithLogicalDelete(@Param("id") Long id, @Param("andLogicalDeleted") boolean andLogicalDeleted);
