...
public interface DgutshopUserRoleMapper {
     ...
     * @mbg.generated
     */
    DgutshopUserRole selectByPrimaryKeySelective(@Param("id") Long id, @Param("selective") DgutshopUserRole.Column ... selective);
     ...
     * @mbg.generated
     */
    DgutshopUserRole selectByPrimaryKey(Long id);
     ...
     * @mbg.generated
     */
    DgutshopUserRole selectByPrimaryKeyWithLogicalDelete(@Param("id") Long id, @Param("andLogicalDeleted") boolean andLogicalDeleted);
